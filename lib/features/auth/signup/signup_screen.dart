        ...
        body: Stack(
          children: [
            ...
            Positioned(top: -80, left: -80,
              child: _Glow(color: accent.withOpacity(glowOpacity), size: 320)),
            Positioned(bottom: -100, right: -60,
              child: _Glow(color: const Color(0xFF3B6FFF).withOpacity(glowOpacity * 0.8), size: 300)),
                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [BoxShadow(color: accent.withOpacity(0.30), blurRadius: 20, spreadRadius: 2)],
                            ),
                        ...
                        Text('Join thousands of MAKAUT students',
                          textAlign: TextAlign.center,
                                ...
                                children: [
                                  ...
                                  _ScholarField(
                                    ...
                                    suffixIcon: IconButton(
                                      icon: Icon(_isPasswordVisible ? Icons.visibility_off_rounded : Icons.visibility_rounded, color: hintColor, size: 20),
                                  ...
                                  _FieldLabel('Confirm Password', textDim),
                                  const SizedBox(height: 8),
                                  _ScholarField(
                                    ...
                                    fieldBorder: fieldBorder, hintColor: hintColor, textColor: textColor,
                                    suffixIcon: IconButton(
                                      icon: Icon(_isConfirmPasswordVisible ? Icons.visibility_off_rounded : Icons.visibility_rounded, color: hintColor, size: 20),
                                  ...
                                  _GradientButton(label: 'Create Account', isLoading: _isLoading, onTap: _signup, accent: accent),
                                  ...
                                  _SocialButton(
                                    ...
                                    textColor: textColor, fieldFill: fieldFill, fieldBorder: fieldBorder,
                                    onTap: () async {
                                      try {
                        ...
                        Row(
                          ...
                          children: [
                            Text("Already have an account? ", style: TextStyle(color: textDim, fontSize: 14)),
                            GestureDetector(
                              onTap: () => Navigator.pushReplacementNamed(context, '/login'),
                              child: Text('Sign In', style: TextStyle(color: accent, fontWeight: FontWeight.w700, fontSize: 14))),
                          ],
                        ),
                        const SizedBox(height: 24),
                      ],
...
class _GradientButton extends StatelessWidget {
  final String label; final bool isLoading; final VoidCallback onTap; final Color accent;
...
class _SocialButton extends StatelessWidget {
  final String label; final IconData iconPath;
  final Color textColor, fieldFill, fieldBorder; final VoidCallback onTap;

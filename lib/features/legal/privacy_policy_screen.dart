            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _buildPolicyItem(
                  ...
                  description:
                      'We collect your Name, Email, College, and Department to create your academic profile on ScholarX.',
                  isDark: isDark,
                  card: card,
                  border: border,
                  text: text,
                ...
                _buildPolicyItem(
                  ...
                  description:
                      'ScholarX accesses Notes, Syllabus, and PYQs. We track your "PRO" status for premium academic resources.',
                  isDark: isDark,
                  card: card,
                  border: border,
                  text: text,
                ...
                _buildPolicyItem(
                  ...
                  description:
                      'If you upload an avatar, it is stored securely on Supabase Storage and associated with your ScholarX ID.',
                  isDark: isDark,
                  card: card,
                  border: border,
                  text: text,
                ...
                _buildPolicyItem(
                  ...
                  description:
                      'Your data is protected by Row Level Security (RLS) in our PostgreSQL backend. You own your data.',
                  isDark: isDark,
                  card: card,
                  border: border,
                  text: text,
                ...
                _buildPolicyItem(
                  ...
                  description:
                      'Premium purchases are handled via Google Play Billing. We do not store your credit card or sensitive financial data.',
                  isDark: isDark,
                  card: card,
                  border: border,
                  text: text,
                ...
                _buildPolicyItem(
                  ...
                  description:
                      'You can delete your account permanently from the Profile screen. This erases all your records immediately.',
                  isDark: isDark,
                  card: card,
                  border: border,
                  text: text,

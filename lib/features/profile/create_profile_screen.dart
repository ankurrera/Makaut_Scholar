        ...
        body: Stack(
          children: [
            ...
            Positioned(top: -120, right: -60,
              child: _Glow(color: accent.withValues(alpha: glowOp), size: 400)),
            Positioned(bottom: -100, left: -80,
              child: _Glow(color: const Color(0xFF3B6FFF).withValues(alpha: glowOp * 0.8), size: 350)),
                          ...
                          child: Column(
                            children: [
                              Text('Build your profile',
                                style: TextStyle(color: textP, fontSize: 28, fontWeight: FontWeight.w800, letterSpacing: -0.6)),
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: _avatarFile == null 
                                    ? Icon(Iconsax.profile_circle_copy, color: accent.withValues(alpha: 0.8), size: 44)
                                    : null,
                                ),
                                // Edit Badge
                                Positioned(
                                  ...
                                  child: Container(
                                    ...
                                    child: const Icon(Iconsax.camera_copy, color: Colors.white, size: 16),
                                  ),
                                ),
                              ],
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                _ProfileField(
                                  ...
                                  isDark: isDark, accent: accent,
                                  validator: (v) => v!.trim().isEmpty ? 'College name is required' : null,
                                ),
                                const SizedBox(height: 20),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Text('Department', style: TextStyle(color: textS, fontSize: 13, fontWeight: FontWeight.w600)),
                                    ),
                                    DropdownButtonFormField<String>(
                                      initialValue: _selectedDepartment,
                                      dropdownColor: card,
                                      style: TextStyle(color: textP, fontSize: 15, fontWeight: FontWeight.w500),
                                      icon: Icon(Iconsax.arrow_down_copy, color: textS, size: 16),
                                      decoration: _fieldDecoration(Iconsax.hierarchy_copy, 'Select branch', isDark, accent),
                            ...
                            child: Center(
                              child: _isLoading
                                ...
                                : Row(
                                    ...
                                    children: const [
                                      Text('Save & Continue', 
                                        style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 17, letterSpacing: 0.2)),
                                      SizedBox(width: 10),
                                      Icon(Iconsax.arrow_right_copy, color: Colors.white, size: 20),
                                    ],
                                  ),
                            ),
                          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isDark ? Colors.white.withValues(alpha: 0.08) : Colors.black.withValues(alpha: 0.05), width: 1),
        boxShadow: [
          BoxShadow(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(30),
        child: BackdropFilter(filter: ImageFilter.blur(sigmaX: 16, sigmaY: 16), child: child),
      ),
    );
  }
}
...
class _ProfileField extends StatelessWidget {
  ...
  const _ProfileField({
    ...
    required this.icon, required this.isDark, required this.accent,
    this.validator,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        Padding(
          padding: const EdgeInsets.only(left: 4, bottom: 8),
          child: Text(label, style: TextStyle(color: textS, fontSize: 13, fontWeight: FontWeight.w600)),
        ),
        TextFormField(
